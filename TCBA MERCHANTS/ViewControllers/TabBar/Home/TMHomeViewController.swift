...
extension TMHomeViewController: UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (arryObjects.count - 1 == indexPath.row) {
            ...
            cell.lblText.applyStyle(labelFont:UIFont.applyOpenSansRegular(fontSize: 12.0) , labelColor: #colorLiteral(red: 0, green: 0.4509803922, blue: 0.7921568627, alpha: 1))
        }else{
            cell.imgLogo.image = #imageLiteral(resourceName: "logo-icon.png")
            cell.lblText.text = arryObjects[indexPath.row]
            cell.lblText.applyStyle(labelFont:UIFont.applyOpenSansRegular(fontSize: 12.0) , labelColor: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))
        }
        return cell
    }
